export default {
  ...
  admin: {
    ...
    groups: {
      ...
      grokPricing: {
        title: 'Grok 价格配置',
        description: '配置 Grok 文本、图片、视频价格。文本按每百万 Token 计费，图片/视频按次计费。留空则使用系统默认值。',
        inputPerMTok: '文本输入 ($/MTok)',
        outputPerMTok: '文本输出 ($/MTok)',
        image1k: '图片 1K ($)',
        image2k: '图片 2K ($)',
        video5s: '视频 5s ($)',
        video10s: '视频 10s ($)',
        video15s: '视频 15s ($)',
        videoQualityMultiplier: '高清倍率'
      },
      soraPricing: {
        title: 'Sora 按次计费',
    ...
    accounts: {
      ...
      types: {
        ...
        grokUpstream: 'Grok2API / OpenAI 兼容上游',
      ...
      grok: {
        title: 'Grok 上游接入',
        baseUrlHint: '填写 Grok2API 服务地址，例如 https://grok.openaiapi.icu',
        apiKeyHint: '填写 Grok2API 的 API Key，用于统一接入 Grok 文本、图片和视频能力'
      },
      anthropic: {
