export default {
  ...
  admin: {
    ...
    groups: {
      ...
      grokPricing: {
        title: 'Grok Pricing',
        description: 'Configure Grok text, image, and video pricing. Text uses USD per MTok, image/video use per-request pricing. Leave empty to use defaults.',
        inputPerMTok: 'Text Input ($/MTok)',
        outputPerMTok: 'Text Output ($/MTok)',
        image1k: 'Image 1K ($)',
        image2k: 'Image 2K ($)',
        video5s: 'Video 5s ($)',
        video10s: 'Video 10s ($)',
        video15s: 'Video 15s ($)',
        videoQualityMultiplier: 'HD multiplier'
      },
      soraPricing: {
    ...
    accounts: {
      ...
      types: {
        ...
        grokUpstream: 'Grok2API / OpenAI-compatible upstream',
      ...
      grok: {
        title: 'Grok Upstream Access',
        baseUrlHint: 'Enter the Grok2API base URL, e.g. https://grok.openaiapi.icu',
        apiKeyHint: 'Enter the Grok2API API key used for Grok text, image, and video access'
      },
      anthropic: {
