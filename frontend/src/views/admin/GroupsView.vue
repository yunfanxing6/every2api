  ...
  <AppLayout>
    ...
    >
      <form id="create-group-form" @submit.prevent="handleCreateGroup" class="space-y-5">
        ...
        <div v-if="createForm.platform === 'grok'" class="border-t pt-4">
          <label class="block mb-2 font-medium text-gray-700 dark:text-gray-300">
            {{ t('admin.groups.grokPricing.title') }}
          </label>
          <p class="text-xs text-gray-500 dark:text-gray-400 mb-3">
            {{ t('admin.groups.grokPricing.description') }}
          </p>
          <div class="grid grid-cols-2 gap-3 mb-4">
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.inputPerMTok') }}</label>
              <input v-model.number="createForm.grok_input_price_per_mtok" type="number" step="0.001" min="0" class="input" placeholder="2.5" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.outputPerMTok') }}</label>
              <input v-model.number="createForm.grok_output_price_per_mtok" type="number" step="0.001" min="0" class="input" placeholder="15" />
            </div>
          </div>
          <div class="grid grid-cols-2 gap-3 mb-4">
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.image1k') }}</label>
              <input v-model.number="createForm.grok_image_price_1k" type="number" step="0.001" min="0" class="input" placeholder="0.134" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.image2k') }}</label>
              <input v-model.number="createForm.grok_image_price_2k" type="number" step="0.001" min="0" class="input" placeholder="0.201" />
            </div>
          </div>
          <div class="grid grid-cols-4 gap-3">
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.video5s') }}</label>
              <input v-model.number="createForm.grok_video_price_5s" type="number" step="0.001" min="0" class="input" placeholder="0.25" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.video10s') }}</label>
              <input v-model.number="createForm.grok_video_price_10s" type="number" step="0.001" min="0" class="input" placeholder="0.40" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.video15s') }}</label>
              <input v-model.number="createForm.grok_video_price_15s" type="number" step="0.001" min="0" class="input" placeholder="0.60" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.videoQualityMultiplier') }}</label>
              <input v-model.number="createForm.grok_video_high_quality_multiplier" type="number" step="0.1" min="0" class="input" placeholder="1.5" />
            </div>
          </div>
        </div>
        ...
        <div v-if="editForm.platform === 'grok'" class="border-t pt-4">
          ...
          <div class="grid grid-cols-2 gap-3 mb-4">
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.inputPerMTok') }}</label>
              <input v-model.number="editForm.grok_input_price_per_mtok" type="number" step="0.001" min="0" class="input" placeholder="2.5" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.outputPerMTok') }}</label>
              <input v-model.number="editForm.grok_output_price_per_mtok" type="number" step="0.001" min="0" class="input" placeholder="15" />
            </div>
          </div>
          <div class="grid grid-cols-2 gap-3 mb-4">
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.image1k') }}</label>
              <input v-model.number="editForm.grok_image_price_1k" type="number" step="0.001" min="0" class="input" placeholder="0.134" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.image2k') }}</label>
              <input v-model.number="editForm.grok_image_price_2k" type="number" step="0.001" min="0" class="input" placeholder="0.201" />
            </div>
          </div>
          <div class="grid grid-cols-4 gap-3">
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.video5s') }}</label>
              <input v-model.number="editForm.grok_video_price_5s" type="number" step="0.001" min="0" class="input" placeholder="0.25" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.video10s') }}</label>
              <input v-model.number="editForm.grok_video_price_10s" type="number" step="0.001" min="0" class="input" placeholder="0.40" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.video15s') }}</label>
              <input v-model.number="editForm.grok_video_price_15s" type="number" step="0.001" min="0" class="input" placeholder="0.60" />
            </div>
            <div>
              <label class="input-label">{{ t('admin.groups.grokPricing.videoQualityMultiplier') }}</label>
              <input v-model.number="editForm.grok_video_high_quality_multiplier" type="number" step="0.1" min="0" class="input" placeholder="1.5" />
            </div>
          </div>
        </div>
        ...
        <div v-if="['openai', 'grok'].includes(createForm.platform)" class="border-t border-gray-200 dark:border-dark-400 pt-4 mt-4">
    ...
    >
      ...
      >
        ...
        <!-- OpenAI Messages 调度配置（仅 openai 平台） -->
        <div v-if="['openai', 'grok'].includes(editForm.platform)" class="border-t border-gray-200 dark:border-dark-400 pt-4 mt-4">
          <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">{{ t('admin.groups.openaiMessages.title') }}</h4>
...
const createForm = reactive({
  ...
  grok_input_price_per_mtok: null as number | null,
  grok_output_price_per_mtok: null as number | null,
  grok_image_price_1k: null as number | null,
  grok_image_price_2k: null as number | null,
  grok_video_price_5s: null as number | null,
  grok_video_price_10s: null as number | null,
  grok_video_price_15s: null as number | null,
  grok_video_high_quality_multiplier: null as number | null,
  // Sora 按次计费配置
...
const closeCreateModal = () => {
  ...
  createForm.grok_input_price_per_mtok = null
  createForm.grok_output_price_per_mtok = null
  createForm.grok_image_price_1k = null
  createForm.grok_image_price_2k = null
  createForm.grok_video_price_5s = null
  createForm.grok_video_price_10s = null
  createForm.grok_video_price_15s = null
  createForm.grok_video_high_quality_multiplier = null
...
const handleEdit = async (group: AdminGroup) => {
  ...
  editForm.grok_input_price_per_mtok = group.grok_input_price_per_mtok
  editForm.grok_output_price_per_mtok = group.grok_output_price_per_mtok
  editForm.grok_image_price_1k = group.grok_image_price_1k
  editForm.grok_image_price_2k = group.grok_image_price_2k
  editForm.grok_video_price_5s = group.grok_video_price_5s
  editForm.grok_video_price_10s = group.grok_video_price_10s
  editForm.grok_video_price_15s = group.grok_video_price_15s
  editForm.grok_video_high_quality_multiplier = group.grok_video_high_quality_multiplier
