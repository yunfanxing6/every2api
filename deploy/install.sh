...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/yunfanxing6/sub2api-grok/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="yunfanxing6/sub2api-grok"
...
Documentation=https://github.com/yunfanxing6/sub2api-grok
