...
// rewriteSystemForNonClaudeCode rewrites non-Claude-Code system prompts into the
// canonical Claude Code system block, while moving original instructions into
// the messages array so upstream behavior stays intact.
