...
func (r *groupRepository) Create(ctx context.Context, groupIn *service.Group) error {
	builder := r.client.Group.Create().
		...
		SetNillableGrokInputPricePerMtok(groupIn.GrokInputPricePerMTok).
		SetNillableGrokOutputPricePerMtok(groupIn.GrokOutputPricePerMTok).
		SetNillableGrokImagePrice1k(groupIn.GrokImagePrice1K).
		SetNillableGrokImagePrice2k(groupIn.GrokImagePrice2K).
		SetNillableGrokVideoPrice5s(groupIn.GrokVideoPrice5S).
		SetNillableGrokVideoPrice10s(groupIn.GrokVideoPrice10S).
		SetNillableGrokVideoPrice15s(groupIn.GrokVideoPrice15S).
		SetNillableGrokVideoHighQualityMultiplier(groupIn.GrokVideoHighQualityMultiplier).
...
func (r *groupRepository) Update(ctx context.Context, groupIn *service.Group) error {
	...
	if groupIn.GrokInputPricePerMTok != nil {
		builder = builder.SetGrokInputPricePerMtok(*groupIn.GrokInputPricePerMTok)
	} else {
		builder = builder.ClearGrokInputPricePerMtok()
	}
	if groupIn.GrokOutputPricePerMTok != nil {
		builder = builder.SetGrokOutputPricePerMtok(*groupIn.GrokOutputPricePerMTok)
	} else {
		builder = builder.ClearGrokOutputPricePerMtok()
	}
	if groupIn.GrokImagePrice1K != nil {
		builder = builder.SetGrokImagePrice1k(*groupIn.GrokImagePrice1K)
	} else {
		builder = builder.ClearGrokImagePrice1k()
	}
	if groupIn.GrokImagePrice2K != nil {
		builder = builder.SetGrokImagePrice2k(*groupIn.GrokImagePrice2K)
	} else {
		builder = builder.ClearGrokImagePrice2k()
	}
	if groupIn.GrokVideoPrice5S != nil {
		builder = builder.SetGrokVideoPrice5s(*groupIn.GrokVideoPrice5S)
	} else {
		builder = builder.ClearGrokVideoPrice5s()
	}
	if groupIn.GrokVideoPrice10S != nil {
		builder = builder.SetGrokVideoPrice10s(*groupIn.GrokVideoPrice10S)
	} else {
		builder = builder.ClearGrokVideoPrice10s()
	}
	if groupIn.GrokVideoPrice15S != nil {
		builder = builder.SetGrokVideoPrice15s(*groupIn.GrokVideoPrice15S)
	} else {
		builder = builder.ClearGrokVideoPrice15s()
	}
	if groupIn.GrokVideoHighQualityMultiplier != nil {
		builder = builder.SetGrokVideoHighQualityMultiplier(*groupIn.GrokVideoHighQualityMultiplier)
	} else {
		builder = builder.ClearGrokVideoHighQualityMultiplier()
	}
