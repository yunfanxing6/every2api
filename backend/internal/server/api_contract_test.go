		...
		},
		{
			...
			wantJSON: `{
				...
				"data": [
					...
					"image_price_2k": null,
					"image_price_4k": null,
					"grok_input_price_per_mtok": null,
					"grok_output_price_per_mtok": null,
					"grok_image_price_1k": null,
					"grok_image_price_2k": null,
					"grok_video_price_5s": null,
					"grok_video_price_10s": null,
					"grok_video_price_15s": null,
					"grok_video_high_quality_multiplier": null,
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	usageService := service.NewUsageService(usageRepo, userRepo, nil, nil, nil, nil)
